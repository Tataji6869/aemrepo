...
@Model(
        ...
        adapters = SightlyInterface.class,
        defaultInjectionStrategy = DefaultInjectionStrategy.OPTIONAL
)
public class SightlyInterfaceImpl implements SightlyInterface{
    private static final Logger LOG = LoggerFactory.getLogger(SightlyInterfaceImpl.class);
